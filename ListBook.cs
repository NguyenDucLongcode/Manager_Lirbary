...
namespace qlDsSinhVien
{
    public class ListBook
    {
        ...
        public ListBook()
        {
            MaSach = TenSach = TheLoai = NgayXB = MaTacGia = GiaTien = "";
        }
        ...
        public ListBook(string csvLine)
        {
            ...
            this.NgayXB = values[3];
            this.MaTacGia = values[4];
            this.GiaTien = values[5];
        }
        ...
        public DataTable ToDataTable(List<ListBook> listbooks)
        {
            ...
            {
                dt.Rows.Add(s.MaSach, s.TenSach, s.TheLoai, s.NgayXB, s.MaTacGia, s.GiaTien);
            }
            return dt;
        }
